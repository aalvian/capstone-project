        ...
        return A().wrap(function (e) {
          for (;;)
            switch ((e.prev = e.next)) {
              ...
              case 3:
                return (i = e.sent), console.log('Berhasil register', i), (e.next = 7), i.json();
              case 7:
                return (a = e.sent), e.abrupt('return', x(x({}, a), {}, { ok: i.ok }));
              case 9:
              case 'end':
                return e.stop();
            }
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        ...
                        case 4:
                          return (e.next = 6), C({ username: n, email: r, password: o });
                        case 6:
                          if ((i = e.sent).ok) {
                            e.next = 9;
                            break;
                          }
                          throw new Error(i.message || 'Registrasi gagal');
                        case 9:
